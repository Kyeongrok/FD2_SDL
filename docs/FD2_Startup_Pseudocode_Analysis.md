# FD2.EXE 启动过程逆向函数伪代码分析

> 基于 IDA Pro MCP 服务器导出的反编译代码整理
...
1. [入口点与主函数](#1-入口点与主函数)
2. [初始化函数](#2-初始化函数)
3. [DAT文件加载器](#3-dat文件加载器)
4. [音频系统函数](#4-音频系统函数)
5. [游戏状态/音乐初始化](#5-游戏状态音乐初始化)
6. [存档加载函数](#6-存档加载函数)
7. [开场动画函数](#7-开场动画函数)
8. [菜单显示函数](#8-菜单显示函数)
9. [视频/显示函数](#9-视频显示函数)
10. [调色板函数](#10-调色板函数)
11. [反编译状态汇总](#11-反编译状态汇总)
...
### 4.3 sub_3908B (0x3908B) - DIG驱动初始化
**反编译状态**: ✅ 已反编译
...
### 5.1 sub_25977 (0x25977) - 状态初始化/音乐控制
**反编译状态**: ✅ 已反编译
...
### 7.1 sub_25EBB (0x25EBB) - 检查存档/进入游戏
**反编译状态**: ✅ 已反编译
...
| sub_37042 | 0x37042 | ✅ | 栈检查 |
| sub_111BA | 0x111BA | ✅ | DAT文件加载器 |
| sub_37D3E | 0x37D3E | ✅ | AIL_startup |
| sub_3AA72 | 0x3AA72 | ✅ | MDI驱动安装 |
| sub_3908B | 0x3908B | ✅ | DIG驱动初始化 |
| sub_392D0 | 0x392D0 | ✅ | 分配采样句柄 |
| sub_3ACA3 | 0x3ACA3 | ✅ | 分配序列句柄 |
| sub_25977 | 0x25977 | ✅ | 状态/音乐初始化 |
| sub_3AF5B | 0x3AF5B | ✅ | 停止音乐 |
| sub_3ADF5 | 0x3ADF5 | ✅ | 初始化序列 |
| sub_3AEEE | 0x3AEEE | ✅ | 开始播放 |
| sub_3B124 | 0x3B124 | ✅ | 设置音量 |
| sub_3B1A6 | 0x3B1A6 | ✅ | 设置循环 |
| sub_3666C | 0x3666C | ✅ | 验证音乐数据 |
| sub_10010 | 0x10010 | ✅ | 加载存档 |
| sub_11019 | 0x11019 | ✅ | 加载图标 |
| sub_25EBB | 0x25EBB | ✅ | 检查存档 |
| sub_1F894 | 0x1F894 | ✅ | 播放开场动画 |
| sub_10620 | 0x10620 | ✅ | 检查按键 |
| sub_4E381 | 0x4E381 | ✅ | 同步视频 |
| sub_4E31C | 0x4E31C | ✅ | 调色板动画 |
| sub_1FF79 | 0x1FF79 | ✅ | 绘制菜单 |
| sub_20421 | 0x20421 | ✅ | 播放ANI动画 |
| sub_1F81E | 0x1F81E | ✅ | 显示特殊画面 |
| sub_1F73F | 0x1F73F | ✅ | 显示特殊场景 |
| sub_11EB0 | 0x11EB0 | ✅ | 帧复制 |
| sub_1F525 | 0x1F525 | ✅ | 淡入效果 |
| sub_1F882 | 0x1F882 | ✅ | 淡出效果 |
| sub_11D40 | 0x11D40 | ✅ | 设置调色板 |
| sub_2DF01 | 0x2DF01 | ✅ | 调色板渐变 |
| sub_17AA9 | 0x17AA9 | ✅ | 视频效果 |

### 未反编译的启动相关函数

| 函数 | 地址 | 状态 | 原因 |
|------|------|------|------|
| start | 0x3CCB4 | ❌ | 库函数被跳过 |
| malloc | 0x3706E | ❌ | 标准库函数 |
| free | 0x3776E | ❌ | 标准库函数 |
| fopen | 0x37324 | ❌ | 标准库函数 |
| fclose | 0x3759C | ❌ | 标准库函数 |
| fread | - | ❌ | 标准库函数 |
| fwrite | 0x377A3 | ❌ | 标准库函数 |
| fseek | 0x37940 | ❌ | 标准库函数 |
| memmove | 0x3771C | ❌ | 标准库函数 |
| memset | 0x37910 | ❌ | 标准库函数 |
| int386 | 0x370F0 | ❌ | DOS扩展函数 |
| printf | 0x37119 | ❌ | 标准库函数 |
| fprintf | 0x3F46B | ❌ | 标准库函数 |
| rand | 0x3CC7D | ❌ | 标准库函数 |
| outp | 0x37AE5 | ❌ | 端口输出 |
| j___delay | 0x3E01D | ❌ | 延时函数 |
...
| 变量 | 地址 | 用途 |
|------|------|------|
| dword_53ED8 | 0x53ED8 | 音频驱动状态 |
| dword_53ED0 | 0x53ED0 | 序列句柄配置 |
| dword_53EDC | 0x53EDC | DIG驱动句柄 |
| dword_53EE4 | 0x53EE4 | 采样句柄1 |
| dword_53EE8 | 0x53EE8 | 采样句柄2 |

### 视频相关
| 变量 | 地址 | 用途 |
|------|------|------|
| 655360 | 0xA0000 | VGA视频缓冲区 |
| dword_53BF7 | 0x53BF7 | 调色板缓冲区 |
| dword_53AD5 | 0x53AD5 | 调色板数据 |
...
| n16_0 | - | 音频启用标志 |
| n6_0 | - | 单位数量 |
| dword_53A45 | 0x53A45 | 单位数据数组 |
| dword_53A55 | 0x53A55 | 存档主数据 |
